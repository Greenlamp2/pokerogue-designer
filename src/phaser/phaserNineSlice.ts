...
export default class PhaserNineSlice {
  scene: PhaserScene;
  public texture: PhaserTexture;
  public frame: PhaserTexture;
  ...
  constructor(scene: PhaserScene, x?: number, y?: number, texture?: string, frame?: PhaserTexture, width?: number, height?: number, leftWidth?: number, rightWidth?: number, topHeight?: number, bottomHeight?: number) {
    this.scene = scene;
    this.texture = new PhaserTexture(texture);
    this.frame = frame;
